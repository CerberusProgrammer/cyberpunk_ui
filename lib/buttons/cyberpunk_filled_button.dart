...
class CyberpunkFilledButtonPainter extends CustomPainter {
  final Color color;

  CyberpunkFilledButtonPainter({required this.color});
  ...
  @override
  bool shouldRepaint(CyberpunkFilledButtonPainter oldDelegate) {
    return oldDelegate.color != color;
  }
}

class CyberpunkFilledButton extends StatefulWidget {
  final String text;
  final IconData? icon;
...
class _CyberpunkFilledButtonState extends State<CyberpunkFilledButton>
      ...
      child: GestureDetector(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) => CustomPaint(
            painter: CyberpunkFilledButtonPainter(
